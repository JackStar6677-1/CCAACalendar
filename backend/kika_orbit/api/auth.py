...
from kika_orbit.domain.admin_roster import AdminRosterEntry, load_admin_roster
from kika_orbit.domain.rut import mask_rut, normalize_rut, rut_hash
from kika_orbit.models import AuditLog, Organization, User
from kika_orbit.schemas import (
    AuthActivateRequest,
    AuthLoginRequest,
    AuthSessionRead,
...
from kika_orbit.security import (
    hash_password,
    hash_token,
    new_public_token,
    reset_token_expiry,
...
def _default_organization(session: Session) -> Organization:
    ...
    organization = Organization(
        ...
        brand_config={"public_name": "Kika Orbit"},
    )
